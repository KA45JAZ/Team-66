...
<body>
  HAD TO DELETE THIS SECTION AS IT WAS NOT LINKING TO THE CSS STYLING-->
<head>
  <meta charset="utf-8">
  <title>Contact Us | Goodfit</title>
  <link rel="icon" type="image/png" href="favicon/GoodFit_favicon.png">

  <link rel="stylesheet" href="styles.css">      <!-- keep if group uses it -->
