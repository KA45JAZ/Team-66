...
$query = $db->prepare("SELECT product_id, name, price, image FROM products WHERE category = 'women'");
$query->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Women's Products - Goodfit</title>
...
<div class="product-listing-container">
    ...
    <div class="product-grid">
        <?php if (empty($products)): ?>
            <p style="color:white; text-align:center;">No women's products available.</p>
        <?php else: ?>
